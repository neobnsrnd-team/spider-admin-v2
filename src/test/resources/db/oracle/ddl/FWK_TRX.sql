-- D_SPIDERLINK.FWK_TRX definition
...
-- DROP TABLE D_SPIDERLINK.FWK_TRX;

CREATE TABLE D_SPIDERLINK.FWK_TRX (
	TRX_ID VARCHAR2(40),
...
CREATE UNIQUE INDEX PK_FWK_TRX ON D_SPIDERLINK.FWK_TRX (TRX_ID);