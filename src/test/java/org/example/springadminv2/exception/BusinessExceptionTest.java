...
class BusinessExceptionTest {
    ...
    void constructor_errorTypeOnly() {
        BusinessException ex = new BusinessException(ErrorType.RESOURCE_NOT_FOUND);
    ...
    void constructor_withDetail() {
        BusinessException ex = new BusinessException(ErrorType.RESOURCE_NOT_FOUND, "orderId=ORD-001");
    ...
    void constructor_withCause() {
        ...
        BusinessException ex = new BusinessException(ErrorType.INTERNAL_ERROR, cause);
    ...
    void constructor_withDetailAndCause() {
        RuntimeException cause = new RuntimeException("root cause");
        BusinessException ex = new BusinessException(ErrorType.INTERNAL_ERROR, "service=payment", cause);
